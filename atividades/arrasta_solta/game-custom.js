...
dragula({
  ...
  $('#bgmodal-acerto').modal('show')
      audio.setAttribute('src','../atividades/arrasta_solta/acerto.mp3'); //change the source
  ...
  $('#bgmodal-erro').modal('show')
      audio.setAttribute('src','../atividades/arrasta_solta/erro.mp3'); //change the source
      audio.load(); //load the new source
      audio.play(); //play
});
